...
function FileUploadCard({
    ...
    const handleFileSelect = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            // Validate by extension only: the browser's file.type MIME guess is
            // unreliable for legacy .doc files across OS/Word versions and can
            // reject valid files before the request is even sent. The server
            // still does the authoritative content-based MIME check.
