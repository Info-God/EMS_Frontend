...
export interface ReviewEvaluationItem {
  ...
  review_id: number;
  reviewer_id: number;
  q1_title_clarity: string | null;
  q2_abstract_clarity: string | null;
  q3_abstract_completeness: string | null;
  q4_research_problem: string | null;
  q5_literature_review: string | null;
  q6_research_gaps: string | null;
  q7_methodology_appropriateness: string | null;
  q8_methodology_clarity: string | null;
  q9_tools_justification: string | null;
  q10_ethical_considerations: string | null;
  q11_results_clarity: string | null;
  q12_tables_figures: string | null;
  q13_data_analysis: string | null;
  q14_interpretation: string | null;
  q15_comparision: string | null;  // Note: comparision (typo in backend)
  q16_limitations: string;
  q17_conclusions_supported: string | null;
  q18_future_research: string | null;
  q19_originality: string | null;
  q20_contribution: string | null;
  q21_plagiarism: string;
  q22_language_quality: string | null;
  q23_format_compliance: string | null;  
  q24_references_relevance: string | null;  
  q25_citation_accuracy:string | null;
  q26_conflict_of_interest: string | null;
  q27_ethical_approval: string;
  q28_overall_recommendation?: string;
  score_originality?: number;
  score_methodology?: number;
  score_clarity?: number;
  score_relevance?: number;
  score_overall_quality?: number;
  comments_to_author?: string;
  confidential_comments_to_editor?: string;
  admin_editorial_decision?: string;
  admin_comments_to_editor_in_chief?: string;
}
